  ...
  const navItems: NavItem[] = [
    ...
    { 
      ...
      children: [
        ...
        { label: 'New Leads', path: '/leads?filter=new' },
        { label: 'Available Leads', path: '/leads?filter=available' },
        { label: 'Claimed Leads', path: '/leads?filter=claimed' },
        { label: 'Contacted Leads', path: '/leads?filter=contacted' },
        { label: 'Qualified Leads', path: '/leads?filter=qualified' },
        { label: 'Follow-up Leads', path: '/leads?filter=follow_up' },
        { label: 'Proposal Sent Leads', path: '/leads?filter=proposal_sent' },
        { label: 'Negotiation Leads', path: '/leads?filter=negotiation' },
        { label: 'Converted Leads', path: '/leads?filter=converted' },
        { label: 'Lost Leads', path: '/leads?filter=lost' },
        { label: 'Duplicate Leads', path: '/leads?filter=duplicate' },
        { label: 'Invalid Leads', path: '/leads?filter=invalid' },
